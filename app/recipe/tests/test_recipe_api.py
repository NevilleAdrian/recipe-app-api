...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_recipe_list_limited_to_user(self):
        """Test list of recipe is limited to unauthenticated user"""
    ...
    def test_create_recipe_with_exiting_tags(self):
        """Test create a recipe with an existing tag"""
    ...
    def test_create_recipe_with_exiting_ingredients(self):
        """Test create a recipe with an existing ingredients"""
